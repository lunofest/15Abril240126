...
function updateTimer() {
  const targetDate = new Date("january 1, 2026 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '541133310990'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '541140646455'; // Número para el primer botón
